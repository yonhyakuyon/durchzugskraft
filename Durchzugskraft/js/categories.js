...
function showProducts(products, category){
    ...
    for (var key in products) {
        if(products[key].category == category){
            ...
            out += `<div class="name">${products[key].name}</div>`;
            out += `<img class="main-image" src="/assets/images/products/${products[key].image}" alt="">`;
            out += `</a>`;
            out += `<div class="price">${products[key].price} ₽</div>`;
